...
function safebuttons() {
    ...
    if (getSetting('safety-extra-shape') == 'true') { safetyButtons("//form[@name='spellaaoettack']/input[@type='submit' and @value='Shape Area Spell (5 AP)']", 'disable'); }
}
...
function libSettings() {
    ...
    var settings = [
        ...
        ['safety', 'b', 'Safe Shape Area', 'shape', 'Adds a safety to Shape Area on Conduit.'],
