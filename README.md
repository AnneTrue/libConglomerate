...
* Alchemy Interface 
  ...
  * Component rarity is displayed. When recipe pane is open, also colours the rarity of items in faction storage, alchemy research/transmutation, and give item menus. Black is common, Green is uncommon, Red is rare. Non-transmutable components (blood and soul ices) are emboldened. 
